...
/**
 * Service provider register the service `parserContext`.
 *
 ...
 */
class ParserContextProvider implements ServiceProviderInterface
{
    /**
        ...
        $azirax->addService(
            ...
            function () use ($azirax) {
                return new ParserContext(
                    $azirax->getService('filter'),
                    $azirax->getService('docBlockParser'),
                    $azirax->getService('prettyPrinter')
                );
            }
        );
    }
