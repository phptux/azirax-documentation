...
use Azirax\Documentation\Parser\DocBlockParser;

/**
 * Service provider register the service `docBlockParser`.
 *
 ...
 */
class DocBlockParserProvider implements ServiceProviderInterface
{
    /**
