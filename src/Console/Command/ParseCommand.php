...
incremental parsing algorithm):
    ...
    <info>php %command.full_name% config/azirax.php --force</info>

The <comment>--version</comment> option overrides the version specified
in the configuration:

    <info>php %command.full_name% config/azirax.php --version=$defaultVersionName</info>
EOF
            );
    }
    ...
    {
        return $this->parse($this->azirax->getService('project'));
    }
}
